...
const OurService = () => {
  ...
  return (
    <section className={style.sectionOurService} id="service">
      <Container>
        ...
        <div className={style.sectionOurServiceContent}>
          <div className={style.sectionOurServiceContentSlides}>
            ...
            >
              <p className={style.sectionOurServiceDesc}>
                Powerful artificial intelligence analyzes your resume and
                provides detailed recommendations on how to improve it. It will
                help increase the chances of success by highlighting strengths
              ...
              <div className={style.sectionOurServiceAnalysis}>
                ...
                <div className={style.sectionOurServiceAnalysisMinus}>
                  ...
                  <p className={style.sectionOurServiceAnalysisText}>
                    Lack of specifics: Poor descriptions of work experience,
                    lack of information about projects, responsibilities,
                    results.
                    <br />
