...
import styles from "./ArhivResume.module.css";
...
import { ReactComponent as Block } from '../../../../assets/user_page/builder/ActiveResume/Resume builder/Personal cabinet/fe_unlock.svg'
  ...
  return (
    <div className={styles.container}>
      <div className={styles.bilderContantContainerNav}>
          ...
          <Link to={'archived'} onClick={handleArchivedClick}>
        ...
        <div className={styles.bilderTableContainer}>
          ...
          <nav className={styles.bilderNavTitles}>
            <div className={styles.tableElement}>
              ...
              >
                  <div className={styles.sectResumeDescScore}>
                      <p className={styles.sectResumeScorePercent}>20</p>
                      <p className={styles.sectResumeScoreText}>100</p>
                  </div>
              </ScoreResumeCircle>
            </div>
